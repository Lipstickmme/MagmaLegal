 ...
 * an unreachable database, a missing row. A contact block going blank is a
 * worse outcome than it being briefly stale. The select is `*` rather than a
 * column list for the same reason: a deployment running ahead of its
